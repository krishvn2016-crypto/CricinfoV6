...
type Tab = 'summary' | 'scorecard' | 'commentary' | 'stats' | 'fantasy' | 'chat';
...
export default function MatchDetail() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const [m, sc, cm, wp, mh, pt, xi, ch] = await Promise.all([
  ...
  const tabs: Tab[] = ['summary', 'scorecard', 'commentary', 'stats', 'fantasy', 'chat'];
